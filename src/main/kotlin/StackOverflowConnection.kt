...
object StackOverflowConnection {
    ...
    private fun downloadAnswerBody(answerNumber: Int): String {
        val request = Fuel.get(answerNumber.toString(), parameters)
        val responseString = request.responseString().third.get()
    ...
    private fun downloadAnswerAllRevisionBodies(answerNumber: Int): Map<Int, String> {
